...
Además, la plataforma incorpora un rol de cuidador, orientado a familiares o personas responsables del adulto mayor. Este rol permite gestionar los medicamentos, programar horarios, consultar el historial de tomas y realizar el seguimiento del tratamiento en aquellos casos en que el adulto mayor tenga dificultades para utilizar dispositivos tecnológicos.

Como complemento, RecorNet ofrece un panel de estadísticas que muestra información relevante sobre el tratamiento, como el número de días de cumplimiento, la cantidad de dosis tomadas y pendientes, el total de medicamentos registrados y otros indicadores que facilitan el seguimiento del estado del tratamiento.

Uno de los principales pilares del proyecto es la accesibilidad. La aplicación ha sido concebida bajo los principios del Diseño Universal y las Pautas de Accesibilidad para el Contenido Web (WCAG), incorporando funciones que permiten su uso por personas con discapacidad visual, auditiva, motriz y cognitiva. Entre estas funciones se incluyen botones de gran tamaño, tipografía ampliable, alto contraste, compatibilidad con lectores de pantalla, mensajes de voz, vibración, navegación sencilla y una interfaz intuitiva que reduce la complejidad de las tareas.
...
El producto integra funcionalidades que permiten gestionar los medicamentos, programar horarios, enviar recordatorios mediante notificaciones, alarmas, mensajes de voz y vibración, así como registrar la confirmación de cada dosis administrada. Además, incorpora un rol de cuidador para apoyar a los adultos mayores que presentan dificultades en el uso de dispositivos móviles, permitiendo supervisar y administrar el tratamiento de forma remota o presencial.

Como valor agregado, RecorNet proporciona un módulo de estadísticas y seguimiento que permite visualizar el cumplimiento del tratamiento mediante gráficos e indicadores, facilitando la toma de decisiones por parte del adulto mayor, sus familiares y los profesionales de la salud.

Desde el punto de vista de la accesibilidad, el sistema está diseñado para atender las necesidades de personas con discapacidad visual, auditiva, motriz y cognitiva, incorporando características como textos ampliables, alto contraste, botones de gran tamaño, compatibilidad con lectores de pantalla, mensajes de voz, vibración y una navegación simple e intuitiva. Estas características buscan reducir las barreras de uso y favorecer la inclusión digital.
